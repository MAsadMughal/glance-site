                ...
                <div className='bg-white flex flex-col rounded-3xl my-20 py-12 md:px-5 lg:px-10 xl:px-24 px-2'>
                    <div className='flex flex-col md:flex-row gap-y-10 md:gap-y-6 gap-x-20 justify-start md:justify-between px-8'>
                        ...
                        <div className='flex flex-col md:w-1/3'>
                            ...
                            <ul className='list-none  sm:text-wrap  lg:text-nowrap text-sm md:text-base text-gray-500 space-y-6'>
                    ...
                    <div className='mt-16 flex flex-col gap-y-4 md:gap-y-5 items-center px-8'>
                        ...
                        <div className='flex flex-row justify-center gap-x-2 text-gray-400'>
                        ...
                        <div className='flex flex-row flex-nowrap text-xs justify-start md:justify-center mt-6 min-w-full md:text-sm'>
